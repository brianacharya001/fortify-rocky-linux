...
RUN wget --user=admin  --password= http://nexus3-openshift-operators.apps.vapo-ppd.com/repository/rapo/rapo/forttify/rockylinux.tar
RUN tar -xvf 
...
RUN wget --user=admin  --password=  http://nexus3-openshift-operators.apps.rapo-ppd.com/repository/rapo/rapo/fortify/jdk-11.0.12_linux-x64_bin.rpm
...
RUN wget  --user=admin  --password= http://nexus3-openshift-operators.apps.rapo-ppd.com/repository/rapo/rapo/fortify/apache-tomcat-9.0.58.tar.gz
...
RUN wget --user=admin  --password=     http://nexus3-openshift-operators.apps.rapo-ppd.com/repository/rapo/rapo/fortify/ssc.war
